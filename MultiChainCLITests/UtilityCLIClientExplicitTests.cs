...
namespace MCWrapper.CLI.Tests.MultiChainCLITests
{
    ...
    public class UtilityCLIClientExplicitTests
    {
        ...
        {
            // Act - fetch fee
            var fee = await Utility.EstimateFeeAsync(Utility.CliOptions.ChainName, 300);
        ...
        {
            // Act - fetch priority
            var priority = await Utility.EstimatePriorityAsync(Utility.CliOptions.ChainName, 300);
